...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
     ...
     * {@link YarnApplicationFileUploader#registerMultipleLocalResources(Collection, String)} since
     * we upload the Flink uber jar ourselves and do not need to deploy it multiple times.
     *
            ...
            try (final FileSystem fs = FileSystem.get(yarnConfiguration)) {
                final Path applicationDir =
                        YarnApplicationFileUploader.getApplicationDirPath(
                                fs.getHomeDirectory(), applicationId);
        ...
        if (jobGraph != null) {
            ...
            try {
                ...
                fileUploader.registerSingleLocalResource(
                        jobGraphFilename, new Path(tmpJobGraphFile.toURI()), "", true, false);
        ...
        if (System.getenv("IN_TESTS") != null) {
            ...
            remoteYarnSiteXmlPath =
                    fileUploader
                            .registerSingleLocalResource(
                                    Utils.YARN_SITE_FILE_NAME, yarnSitePath, "", false, false)
                            .getPath();
            ...
            if (krb5Config != null && krb5Config.length() != 0) {
                ...
                remoteKrb5Path =
                        fileUploader
                                .registerSingleLocalResource(
                                        Utils.KRB5_FILE_NAME, krb5ConfPath, "", false, false)
                                .getPath();
                hasKrb5 = true;
            }
        }
        ...
        if (keytab != null) {
            ...
            if (localizeKeytab) {
                ...
                remotePathKeytab =
                        fileUploader
                                .registerSingleLocalResource(
                                        localizedKeytabPath, new Path(keytab), "", false, false)
                                .getPath();
            } else {
