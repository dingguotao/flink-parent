...
class LocalBufferPool implements BufferPool {
    ...
    @Nullable private final BufferPoolOwner bufferPoolOwner;
     ...
     * @param numberOfRequiredMemorySegments minimum number of network buffers
     * @param maxNumberOfMemorySegments maximum number of network buffers to allocate
     * @param bufferPoolOwner the owner of this buffer pool to release memory when needed
                    ...
                    if (listener == null) {
                        boolean wasUnavailable =
                                availableMemorySegments.isEmpty()
                                        || oldUnavailableSubpartitionsCount > 0;
    ...
    public CompletableFuture<?> getAvailableFuture() {
        if (numberOfRequestedMemorySegments >= currentPoolSize
            ...
            return CompletableFuture.anyOf(
                    ...
                    networkBufferPool.getAvailableFuture());
        }
    }
