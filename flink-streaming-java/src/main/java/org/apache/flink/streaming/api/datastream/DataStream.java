...
public class DataStream<T> {
    ...
    /**
     * Operator used for directing tuples to specific named outputs using an {@link
     * org.apache.flink.streaming.api.collector.selector.OutputSelector}. Calling this method on an
     * operator creates a new {@link SplitStream}.
     *
     * @param outputSelector The user defined {@link
     *     org.apache.flink.streaming.api.collector.selector.OutputSelector} for directing the
     *     tuples.
     ...
     * of the closing data stream to the head. Refer to {@link #split(OutputSelector)} for more
     * information.
     *
     ...
     *
     * <p>For writing to a file system periodically, the use of the "flink-connector-filesystem" is
     * recommended.
     *
